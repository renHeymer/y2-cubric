...
if (typeof NProgress != 'undefined') {
	...
	// function init_gauge(haveCompletedTraining) {
	...
	// 		chart_gauge_01.set(haveCompletedTraining);
    ...
    xhttp.onreadystatechange = function() {
        if (xhttp.readyState === 4) {
            if (xhttp.status === 200) {
                ...
                var totalActiveUsers = results['totalActiveUsers'];
                var totalOutliers = results['totalOutliers'];
                console.log(results);
                console.log(totalActiveUsers);
                console.log(totalOutliers);
